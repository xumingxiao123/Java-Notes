...
![img](https://www.runoob.com/wp-content/uploads/2018/04/021558444183591.jpg)
...
* **加载：加载是指将类的.class文件中的二进制数据读入到内存中，将其放在运行时数据区的方法区内，最后在堆区创建一个java.lang.Class对象，用来封装类在方法区内的数据结构**。
  ...
  > - 将该字节流表示的**静态存储结构**转换为**方法区**的运行时存储结构。
  > - 在**内存**中生成一个代表该类的 **Class 对象**，作为方法区中该类各种数据的访问入口。
  >
  > 其中二进制字节流可以从以下方式中获取：
  >
...
- [一、数据结构中的堆和栈](https://blog.csdn.net/qq_41498261/article/details/83583466#_1)
- - [1. 栈](https://blog.csdn.net/qq_41498261/article/details/83583466#1__2)
  - [2. 堆](https://blog.csdn.net/qq_41498261/article/details/83583466#2__7)
- [二、内存中的栈区与堆区](https://blog.csdn.net/qq_41498261/article/details/83583466#_13)
- - [1. 内存中的栈区与堆区比较](https://blog.csdn.net/qq_41498261/article/details/83583466#1__14)
  - [2. 计算机内存的大致划分](https://blog.csdn.net/qq_41498261/article/details/83583466#2__20)
- [三、栈内存与栈溢出](https://blog.csdn.net/qq_41498261/article/details/83583466#_25)
- [四、堆内存与内存泄露](https://blog.csdn.net/qq_41498261/article/details/83583466#_43)
- [五、JAVA](https://blog.csdn.net/qq_41498261/article/details/83583466#JAVA_65)
- - [1. Java中的堆与栈](https://blog.csdn.net/qq_41498261/article/details/83583466#1_Java_66)
  - [2. 引用变量](https://blog.csdn.net/qq_41498261/article/details/83583466#2__82)
  - [3. 堆和非堆内存](https://blog.csdn.net/qq_41498261/article/details/83583466#3__89)
- [六、《C++内存管理技术内幕》](https://blog.csdn.net/qq_41498261/article/details/83583466#C_104)
- - [1. C++中，内存分成5个区](https://blog.csdn.net/qq_41498261/article/details/83583466#1_C5_105)
  - - - [a)栈](https://blog.csdn.net/qq_41498261/article/details/83583466#a_107)
      - [b)堆](https://blog.csdn.net/qq_41498261/article/details/83583466#b_113)
      - [c)自由存储区](https://blog.csdn.net/qq_41498261/article/details/83583466#c_119)
      - [d)全局/静态存储区](https://blog.csdn.net/qq_41498261/article/details/83583466#d_122)
      - [e)常量存储区](https://blog.csdn.net/qq_41498261/article/details/83583466#e_124)
  - [2. C++中，内存分成3个区](https://blog.csdn.net/qq_41498261/article/details/83583466#2_C3_127)
  - - - [a)静态存储区](https://blog.csdn.net/qq_41498261/article/details/83583466#a_129)
      - [b)栈区](https://blog.csdn.net/qq_41498261/article/details/83583466#b_131)
      - [c)堆区](https://blog.csdn.net/qq_41498261/article/details/83583466#c_136)
- [总结](https://blog.csdn.net/qq_41498261/article/details/83583466#_145)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/20181031132446857.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3FxXzQxNDk4MjYx,size_16,color_FFFFFF,t_70)
...
- 当在一段代码块**定义一个变量**时，Java就在**栈**中为这个变量分配内存空间，
- 当超过变量的作用域后，Java 会自动**释放**掉为该变量分配的内存空间，该内存空间可以立即被另作它用。

------

堆内存用来存放**由 new 创建的对象和数组**，在堆中分配的内存，由 Java 虚拟机的自动垃圾回收器来管理。

**2. 引用变量**

在堆中产生了一个数组或者对象之后，还可以在栈中定义一个特殊的变量，让**栈中的这个变量的取值等于数组或对象在堆内存中的首地址，栈中的这个变量就成了数组或对象的引用变量，以后就可以在程序中使用栈中的引用变量来访问堆中的数组或者对象，引用变量就相当于是为数组或者对象起的一个名称**。

引用变量是普通的变量，定义时在**栈中分配**，引用变量在程序运行到其作用域之外后被释放。

而数组和对象本身在堆中分配，即使程序运行到使用 new 产生数组或者对象的语句所在的代码块之外，数组和对象本身占据的内存不会被释放，**数组和对象在没有引用变量指向它的时候，才变为垃圾，不能在被使用**，但仍然占据内存空间不放，在随后的一个不确定的时间被**垃圾回收器**收走(释放掉)。
...
都在非堆内存中。
![在这里插入图片描述](https://img-blog.csdnimg.cn/20181031134623342.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3FxXzQxNDk4MjYx,size_16,color_FFFFFF,t_70)
